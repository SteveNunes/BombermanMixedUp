...
public class ColorMix {
	...
	public ColorMix() {
		pallete = Tools.newColorMixPallete();
	}
	...
	public ColorMix setGlobalOpacity(double opacity) {
		if (opacity < 0 || opacity > 1)
			throw new RuntimeException("Invalid value (Expected: 0.0 - 1.0)");
		pallete.set(5, new Color(opacity, pallete.get(5).getGreen(), pallete.get(5).getBlue(), 1));
		return this;
	}
	...
	public double getColorAdjustHue() {
		return pallete.get(3).getRed();
	}
	
	public ColorMix setColorAdjustHue(double hue) {
		if (hue < 0 || hue > 1)
			throw new RuntimeException("Invalid value (Expected: 0.0 - 1.0)");
		pallete.set(3, new Color(hue, pallete.get(3).getGreen(), pallete.get(3).getBlue(), 1));
		return this;
	}
	
	public double getColorAdjustSaturation() {
		return pallete.get(3).getGreen();
	}
	
	public ColorMix setColorAdjustSaturation(double saturation) {
		if (saturation < 0 || saturation > 1)
			throw new RuntimeException("Invalid value (Expected: 0.0 - 1.0)");
		pallete.set(3, new Color(pallete.get(3).getRed(), saturation, pallete.get(3).getBlue(), 1));
		return this;
	}
	
	public double getColorAdjustBrightness() {
		return pallete.get(3).getBlue();
	}
	
	public ColorMix setColorAdjustBrightness(double brightness) {
		if (brightness < 0 || brightness > 1)
			throw new RuntimeException("Invalid value (Expected: 0.0 - 1.0)");
		pallete.set(3, new Color(pallete.get(3).getRed(), pallete.get(3).getGreen(), brightness, 1));
		return this;
	}
	
	public boolean getColorAdjustState() {
		return (int)pallete.get(5).getGreen() == 1;
	}
	
	public ColorMix setColorAdjustState(boolean state) {
		pallete.set(5, new Color(pallete.get(5).getRed(), state ? 1 : 0, pallete.get(5).getBlue(), 1));
		return this;
	}
	...
	public double getColorTintRed() {
		return pallete.get(4).getRed();
	}
	
	public ColorMix setColorTintRed(double red) {
		if (red < 0 || red > 1)
			throw new RuntimeException("Invalid value (Expected: 0.0 - 1.0)");
		pallete.set(4, new Color(red, pallete.get(4).getGreen(), pallete.get(4).getBlue(), 1));
		return this;
	}
	
	public double getColorTintGreen() {
		return pallete.get(4).getGreen();
	}
	
	public ColorMix setColorTintGreen(double green) {
		if (green < 0 || green > 1)
			throw new RuntimeException("Invalid value (Expected: 0.0 - 1.0)");
		pallete.set(4, new Color(pallete.get(4).getRed(), green, pallete.get(4).getBlue(), 1));
		return this;
	}
	
	public double getColorTintBlue() {
		return pallete.get(4).getBlue();
	}
	
	public ColorMix setColorTintBlue(double blue) {
		if (blue < 0 || blue > 1)
			throw new RuntimeException("Invalid value (Expected: 0.0 - 1.0)");
		pallete.set(4, new Color(pallete.get(4).getRed(), pallete.get(4).getGreen(), blue, 1));
		return this;
	}
	...
	public ColorMix setColorTintOpacity(double opacity) {
		if (opacity < 0 || opacity > 1)
			throw new RuntimeException("Invalid value (Expected: 0.0 - 1.0)");
		pallete.set(5, new Color(pallete.get(5).getRed(), pallete.get(5).getGreen(), opacity, 1));
		return this;
	}
	...
	public boolean getSepiaToneState() {
		return (int)pallete.get(6).getRed() == 1;
	}
	
	public ColorMix setSepiaToneState(boolean state) {
		pallete.set(6, new Color(state ? 1 : 0, pallete.get(6).getGreen(), pallete.get(6).getBlue(), 1));
		return this;
	}
	
	public double getSepiaToneLevel() {
		return pallete.get(6).getGreen();
	}
	
	public ColorMix setSepiaToneLevel(double level) {
		if (level < 0 || level > 1)
			throw new RuntimeException("Invalid level (Expected: 0.0 - 1.0)");
		pallete.set(6, new Color(pallete.get(6).getRed(), level, pallete.get(6).getBlue(), 1));
		return this;
	}
	...
	public ColorMix setBloomThreshold(double threshold) {
		...
		pallete.set(7, new Color(pallete.get(7).getRed(), threshold, pallete.get(7).getBlue(), 1));
		return this;
	}
	...
	public boolean getGlowState() {
		return (int)pallete.get(6).getBlue() == 1;
	}
	
	public ColorMix setGlowState(boolean state) {
		pallete.set(6, new Color(pallete.get(6).getRed(), pallete.get(6).getGreen(), state ? 1 : 0, 1));
		return this;
	}
	
	public double getGlowLevel() {
		return pallete.get(7).getBlue();
	}
	
	public ColorMix setGlowLevel(double level) {
		if (level < 0 || level > 1)
			throw new RuntimeException("Invalid threshold (Expected: 0.0 - 1.0)");
		pallete.set(7, new Color(pallete.get(7).getRed(), pallete.get(7).getGreen(), level, 1));
		return this;
	}
