...
public enum TileProp {
	...
	FIXED_ITEM(18), // Tile onde deverá haver um item (pego em ordem da lista de itens definida no
	                // arquivo do mapa em SETUP FixedItemList
	HOLE(19), // Buraco (Só pode atravessar voando ou pulando, explosão passa por cima)
	DEEP_HOLE(20), // Buraco profundo (Se a bomba cair nesse tile, causa o efeito da bomba caindo
	               // diminuindo)
	...
	EXPLOSION(24),
	CPU_DANGER(25), // Tile marcado com esse prop significa que esse tile será atingido pela explosão de alguma bomba, mas essa bomba ainda não está perto de explodir (Serve apenas para orientar a CPU a evitar explosões)
	CPU_DANGER_2(26), // Tile marcado com esse prop significa que esse tile será atingido pela explosão de alguma bomba que está perto de explodir (Serve apenas para orientar a CPU a evitar explosões)
	...
	SLIMY(32), // Pegajoso (Igual SPEED_MIN, além de não permitir chutar nem agarrar bomba
	           // depositada nesse tile)
	...
	TREADMILL_TO_LEFT(37), // Esteira (Vai empurrando objetos em cima dela (incluindo bombas e itens) para
	                       // a esquerda
	TREADMILL_TO_UP(38), // Esteira (Vai empurrando objetos em cima dela (incluindo bombas e itens) para
	                     // cima
	TREADMILL_TO_RIGHT(39), // Esteira (Vai empurrando objetos em cima dela (incluindo bombas e itens) para
	                        // a direita
	TREADMILL_TO_DOWN(40), // Esteira (Vai empurrando objetos em cima dela (incluindo bombas e itens) para
	                       // baixo
	...
	TELEPORT_FROM_FLOATING_PLATFORM(45), // Tile especial que deve ficar ao redor de plataformas flutuantes, que
	                                     // teleporta a bomba ou o player para o tile correspondente como se ele tivesse
	...
	TRIGGER_WHEN_STEP_OUT(64), // Combinado com um TRIGGER_BY_* só dispara o evento quando após pisar no tile,
	                           // o objeto sair do tile
	TRIGGER_BY_PLAYER(65), // As Tags de tile só são disparadas se o jogador (COM ou SEM montaria) pisar no
	                       // tile
